...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_existing_tag(self):
        """Test creating recipe with a existing tag."""
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating recipe with a existing ingredient."""
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_breakfast = Ingredient.objects.create(user=self.user,
                                                         name='Breakfast')
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredient_breakfast)
        ingredient_lunch = Ingredient.objects.create(user=self.user,
                                                     name='Lunch')
        payload = {'ingredients': [{'name': 'Lunch'}]}
        url = detail_url(recipe.id)
        res = self.client.patch(url, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai Vegetable Cuury')
